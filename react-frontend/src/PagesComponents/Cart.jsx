        ...
        <div className="row">
          <div className="col-lg-8 d-flex flex-column justify-content-center">
            ...
            {cartItems.length === 0 ? (
              ...
              <p style={{ fontWeight: 600, margin: 20, padding: 20, outline: "inset", textAlign: "center", backgroundColor: "#cfcfaeff", color: "#6d4103ff", borderRadius: "5px" }}><FontAwesomeIcon icon="fa-solid fa-face-frown"/> Cart is Empty..</p>
              </>
            ) :
